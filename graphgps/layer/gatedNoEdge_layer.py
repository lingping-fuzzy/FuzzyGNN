...
class GatedNoEdgeLayer(pyg_nn.conv.MessagePassing):
    """
        GatedGCN layer
...
class GatedNoEdgeGraphGymLayer(nn.Module):
    """GatedGCN layer.
    Residual Gated Graph ConvNets
    https://arxiv.org/pdf/1711.07553.pdf
    """
    def __init__(self, layer_config: LayerConfig, **kwargs):
        super().__init__()
        self.model = GatedNoEdgeLayer(in_dim=layer_config.dim_in,
...
register_layer('gatedNoEdgeconv', GatedNoEdgeGraphGymLayer)
