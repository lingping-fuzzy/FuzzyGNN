...
def preformat_TUDataset(dataset_dir, name):
    ...
    Returns:
        PyG dataset object: https://chrsmrrs.github.io/datasets/docs/datasets/
        ['DD', 'NCI1', 'ENZYMES', 'PROTEINS', 'MUTAG']:
            2, 2, 6, 2,  2
    """
    if name in ['DD', 'NCI1', 'ENZYMES', 'PROTEINS', 'MUTAG', 'OHSU', 'Peking_1', 'SYNTHETICnew', 'SYNTHETIC']:
        func = None
